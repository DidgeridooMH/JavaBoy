...
/**
 * Handles writing pixels to the main display. Also, handles all the LCD related
 * registers by bypassing the memory.
 * 
...
public class GPU {
    ...
    /**
     * Initializes a display window as well as sets the video related registers to
     * default values.
     * 
    ...
    /**
     * Retrieves the value of a hardware register at a specified address. Returns a
     * 0xFF if there was an error.
     * 
    ...
    public byte readRegister(int address) {
        ...
        case 0xFF4B:
            return windowX;
        default:
            System.err.println("GPU read fault: " + "at address " + Utils.hex(address));
            return (byte) 0xFF;
        }
    }

    /**
     * Writes to a hardware register within the LCD video module.
     * 
    ...
    public void writeRegister(byte in, int address) {
        ...
        case 0xFF4B:
            ...
            break;
        default:
            System.err.println("GPU write fault: " + "[" + Utils.hex(in) + "] " + "at address " + Utils.hex(address));
        }
    }
}
